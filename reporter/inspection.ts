/**
 * Inspection Reporter - HTTP client for sending events to the inspection server.
 *
...
import type { InspectionReporter, TokenUsage } from "./types";
...
export function createHttpInspectionReporter(
    ...
    return {
        ...
        async tokens(usage: TokenUsage): Promise<void> {
            try {
